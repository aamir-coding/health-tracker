...
function SidebarContent({ onNavClick, streak }) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Logo */}
      <div className="px-5 py-5" style={{ borderBottom: '1px solid rgba(255,255,255,0.22)' }}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            >
              <Heart className="w-4 h-4 text-white" fill="white" style={{ filter: 'drop-shadow(0 0 4px rgba(255,255,255,0.5))' }} />
            </div>
      ...
      <div className="px-3 py-4" style={{ borderTop: '1px solid rgba(255,255,255,0.22)' }}>
        <Link
          ...
          style={{ ':hover': { background: 'rgba(255,255,255,0.2)' } }}
